                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <p class="text-white-50">
                            Esta pagina esta diseñada por dos jovenes soñadores con metas por delante queriendo salir adelante con un proyecto diseñado a todo el ambito tecgnologico por eso te invito a que te tomes la delicadeza de explorar cada uno de los rincones de nuestra fabulosa creacion,
                    ...
                    <div class="col-md-10 col-lg-8 mx-auto text-center">
                        ...
                        <form class="form-signup" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="row input-group-newsletter">
                                <div class="col"><input class="form-control" id="emailAddress" type="email" placeholder="Ingresa Direccion de correo" aria-label="Ingresa Direccion de correo" data-sb-validations="required,email" /></div>
                                <div class="col-auto"><button class="btn btn-primary disabled" id="submitButton" type="submit">Notificame</button></div>
                            </div>
                            <div class="invalid-feedback mt-2" data-sb-feedback="emailAddress:required">Se requiere un correo electronico</div>
